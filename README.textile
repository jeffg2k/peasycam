...
camera.setReversePan(boolean reverse); //reverses pan direction when true
camera.setReverseZoom(boolean reverse); //reverses zoom direction when true
camera.setReverseRotate(boolean reverse); //reverses rotate direction when true
