...
camera.setMaximumPanDistance(double maximumDistance);  // clamp panning  default to start look-at point
camera.setMaximumPanDistance(double x, double y, double z, double maximumDistance);  specify pan center
